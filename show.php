...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center header-transparent"
        style="background: rgba(1, 4, 136, 0.9);">
...
?>
                        <tr>
                            ...
                            <td>
                                <center><a href="edit.php?ID=<?php echo $Result['ID'];?>"
                                        class="btn btn-sm btn-warning"><i class="far fa-edit fa-fw"></i> </a>&nbsp;<a
                                        href="remove.php?ID=<?php echo $Result['ID'];?>"
                                        class="btn btn-sm btn-danger"><i class="fa fa-fw fa-trash"></i></a></center>
                            </td>
                            </button></center>
                            </td>
                        </tr>
...
?>
                                    <tr>
                                        ...
                                        <td>
                                            <center><a href="edit.php?ID=<?php echo $Result['ID'];?>"
                                                    class="btn btn-sm btn-warning"><i class="far fa-edit fa-fw"></i>
                                                </a>&nbsp;<a href="remove.php?ID=<?php echo $Result['ID'];?>"
                                                    class="btn btn-sm btn-danger"><i class="fa fa-fw fa-trash"></i></a>
                                            </center>
                                        </td>
                                        </button></center>
                                        </td>
                                ...
                                <form action="insert.php" method="post" id="CommentForm">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" id="idName"
                                            placeholder="Thanawat Jantawong" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="tel" name="tel" id="idtel" class="form-control" required>
                                    </div>
