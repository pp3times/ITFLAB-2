                ...
                <div class="box shadow">
                    <div class="box-body">
                        <div class="row">
                            <div class="col-6">
                                <center>
                                    <h1 class="font-weight-light">User edit</h1>
                                </center>
                            </div>
                        </div>
                        <form action="upload.php" method="post">
                            <input type="text" name="id" value="<?php echo $data['ID']; ?>" class="form-control d-none"
                                required> 
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="comment" class="form-control" rows="5"
                                    required><?php echo $data['comment']; ?></textarea>
                            </div>
                            <div class="form-group">
                                <label>tel</label>
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-sm btn-dark my-3 font-weight-ligh">Save</button>
